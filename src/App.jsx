        ...
        <div className="container mt-5">
          <div className="row align-items-center g-5">
            ...
            <div className="col-lg-6 text-center text-lg-start">
              ...
              >
                Building high-performance web solutions that combine
                cutting-edge technology with stunning visual aesthetics.
              </p>
        ...
        <div className="container py-5">
          <div className="row align-items-center g-5">
            ...
            <div className="col-lg-7">
              ...
              <a
                href="/portfolio/Soad_Amr_Fathy_cv.pdf"
                target="_blank"
            ...
            {[
              {
                ...
                issuer: "IT Sharks",
                img: "/portfolio/front-end.jpeg",
                link: "/portfolio/front-end.jpeg",
              },
              {
                title: "Front End Dev",
                issuer: "Netlab Academy",
                img: "/portfolio/front.jpeg",
                link: "/portfolio/front.jpeg",
              },
              {
                title: "Design Thinking",
                issuer: "Netlab Academy",
                img: "/portfolio/design.jpeg",
                link: "/portfolio/design.jpeg",
              },
              {
                title: "ICDL Certificate",
                issuer: "Cairo University",
                img: "/portfolio/icdl.jpeg",
                link: "/portfolio/icdl.jpeg",
              },
            ].map((cert, index) => (
              <div
                key={index}
                  ...
                  <div className="cert-img-container">
                    ...
                    <div className="cert-overlay">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="btn btn-pink-custom rounded-pill"
                      >
                        View
                      </a>
                    </div>
              ...
              >
                <div className="skill-card-new">
                  <div className="skill-icon-wrap">
                    <i
                      className={`${skill.icon === "fa-js" ? "fa-brands" : "fa-solid"} ${skill.icon} fs-2 pink-text`}
                    ></i>
                  </div>
                  ...
                  <div className="progress-container mt-3">
                    <div className="d-flex justify-content-between mb-1">
                      ...
                      <span className="pink-text small fw-bold">
                        {skill.level}
                      </span>
                    </div>
                    <div
          ...
          <div className="row g-4">
            {[
              ...
              },
              {
                id: 2,
                title: "Wood-Website",
                tech: "Bootstrap / CSS / AOS / React",
                img: wood,
                link: "https://soadamrf.github.io/Wood-Website/",
                github: "https://github.com/soadAmrF/Wood-Website",
              },
              {
                id: 3,
                title: "Shopco-website",
                tech: "Bootstrap / CSS / React",
                img: shopco,
                link: "https://soadamrf.github.io/shopco/",
                github: "https://github.com/soadAmrF/shopco",
              },
              {
                id: 4,
                ...
                tech: "Bootstrap / CSS / React",
                img: safety,
                link: "https://soadamrf.github.io/Safety-platform/",
                github: "https://github.com/soadAmrF/Safety-platform",
              },
            ].map((proj, index) => (
              <div
                key={proj.id}
                ...
                <div className="project-card-custom h-100">
                  ...
                  <div className="project-details p-4">
                    ...
                    <p className="text-secondary small">
                      High-performance web solution focused on user experience
        ...
        <div className="container py-5 text-center">
          ...
          <div className="row g-4 justify-content-center mt-4">
            ...
            <div className="col-lg-3 col-md-6">
              <a
                href="https://api.whatsapp.com/send?phone=201012843104"
                target="_blank"
                rel="noreferrer"
              ...
              >
                <div className="contact-modern-card p-4">
                  ...
                  <span className="action-link">
                    Chat Now <i className="fa-solid fa-arrow-right ms-1"></i>
                  </span>
                </div>
              </a>
            </div>
            ...
            <div className="col-lg-3 col-md-6">
              <a
                href="https://github.com/soadAmrF"
                target="_blank"
                rel="noreferrer"
                className="contact-card-link"
              >
            ...
            <div className="col-lg-3 col-md-6">
              <a
                href="mailto:soadAmrfathy@gmail.com"
                className="contact-card-link"
              >
                <div className="contact-modern-card p-4 highlight-card">
                  ...
                  <span className="action-link">
                    Send Mail <i className="fa-solid fa-arrow-right ms-1"></i>
                  </span>
                </div>
              </a>
            </div>
            ...
            <div className="col-lg-3 col-md-6">
              <a
                href="https://www.linkedin.com/in/soad-amr-fathy/"
                target="_blank"
                rel="noreferrer"
                className="contact-card-link"
              >
                <div className="contact-modern-card p-4">
                  ...
                  <span className="action-link">
                    Connect <i className="fa-solid fa-arrow-right ms-1"></i>
                  </span>
                </div>
              </a>
            </div>
          ...
          <footer className="mt-5 pt-5 border-top border-secondary border-opacity-10">
            <p className="text-secondary mb-0">
              © 2026 Crafted with <span className="pink-text">♥</span> by Soad
              Amr
            </p>
          </footer>
        </div>
